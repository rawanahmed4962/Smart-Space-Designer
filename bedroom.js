...
// Materials
// Change this specific section in the JS:
const wallMaterial = new THREE.MeshStandardMaterial({ color: 0x1f3a52, roughness: 1.0 });
const floorMaterial = new THREE.MeshStandardMaterial({ color: 0x4a4a4a, roughness: 0.9 });
